...
* **Advanced Document Ingestion (LlamaIndex):** Utilizes LlamaIndex for high-fidelity PDF parsing and semantic chunking. Implements SentenceSplitter to maintain context integrity across document segments.
...
- **Data Framework:** LlamaIndex (PDFReader & SentenceSplitter)
